...
var _STAR_html_mode_STAR_26995 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_26995;
}});
/**
...
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__26996){
var vec__26998 = p__26996;
var name = cljs.core.nth.call(null,vec__26998,(0),null);
var value = cljs.core.nth.call(null,vec__26998,(1),null);
if(value === true){
if(cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_.call(null))){
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__26999){
var vec__27002 = p__26999;
var tag = cljs.core.nth.call(null,vec__27002,(0),null);
var content = cljs.core.nthnext.call(null,vec__27002,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else {
}

var vec__27003 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__27003,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__27003,(1),null);
var id = cljs.core.nth.call(null,vec__27003,(2),null);
var class$ = cljs.core.nth.call(null,vec__27003,(3),null);
...
var vec__27005 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__27005,(0),null);
var attrs = cljs.core.nth.call(null,vec__27005,(1),null);
var content = cljs.core.nth.call(null,vec__27005,(2),null);
if(cljs.core.truth_((function (){var or__18116__auto__ = content;
...
//# sourceMappingURL=runtime.js.map?rel=1434173007336